  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      >
        ...
        {/* Adresa */}
        <Text className="text-blue-400 text-2xl mt-8 mb-1">
          Adresa lokacije
        </Text>
        ...
        <View>
          ...
          {/* Vreme preuzimanja */}
          <Text className="text-blue-400 text-2xl mt-8 mb-3">
            Vreme preuzimanja
          </Text>
          <View className="bg-blue-400 rounded-xl flex-col justify-center items-center gap-7 p-5">
            <View className="flex-row items-center justify-center gap-4 ">
              <FontAwesome name="truck" size={32} color={"white"} />
              <Text className="text-white text-xl">Preuzimanje poridzbine</Text>
            </View>
            <TouchableOpacity
