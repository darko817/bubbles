...
const newOrdersScreen = () => {
  ...
  const { newOrders, acceptOrder, denyOrder } = useOrderContext();
  ...
  return (
    <View className="bg-white flex-1">
            ...
            {selectedOrder && (
              <>
                ...
                <View className="flex-row justify-around">
                  <TouchableOpacity
                    onPress={handleDeny}
                    className="bg-red-500 rounded-xl p-3 flex-row items-center justify-center gap-2 w-40"
                  >
                  ...
                  <TouchableOpacity
                    ...
                    className="bg-green-500 rounded-xl p-3 flex-row items-center justify-center gap-2 w-40"
                  >
      ...
      {isAcceptedModalVisible && (
        <AcceptedModal
          title="Porudzbina preuzeta"
          isVisible={isAcceptedModalVisible}
          onCancel={() => setIsAcceptedModalVisible(false)}
          link="/(home)/(worker)/acceptedOrders"
        />
      )}
    </View>
  );
